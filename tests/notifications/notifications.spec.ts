...
import { notificationQwil } from "../../src/event-listener/core/events/notification-qwil";
...
describe('Notifications', () => {
    ...
    xit('Send a notification to Twitter', async () => {
    ...
    xit('Send a notification to Qwil', async () => {
        const triggers = await weaveTriggers();
        ...
        // const info = {};        
        const notification = await notificationQwil(triggers, {
            type: 'NEW_IDEA_NFT',
            info,
        } as INotification<any>);
